...
public class AutoScaleScrollView extends ScrollView {
	private static final String TAG = "AutoScaleScrollView";
	...
	public AutoScaleScrollView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initFromAttributes(context, attrs);
	}

	public AutoScaleScrollView(Context context, AttributeSet attrs, int defStyle) {
	...
	protected boolean checkLayoutParams(android.view.ViewGroup.LayoutParams p) {
		...
		if (isChecked) {
			...
			if (DEBUG) {
				Log.d(TAG, "in checkLayoutParams(AutoScaleScrollView.LayoutParams p), width=" + width + ", height=" + height
						+ "; after scale, width=" + lp.width + ", height=" + lp.height + "; arg p=" + p);
			}
		} else {
